abstract class AdminGenerateQuestionEvent {
  const AdminGenerateQuestionEvent();

  List<Object> get props => [];
}

final class AdminGenerateQuestionWithAIEvent
    extends AdminGenerateQuestionEvent {
  final String? type;
  ...
  const AdminGenerateQuestionWithAIEvent({
    this.type,
    this.difficulty,
    this.category,
    this.topic,
