...
/// Desktop layout for the Teacher Profile page
///
/// Uses BLoC pattern for state management.
/// Displays teacher profile information with edit, change password, and logout options.
class TeacherProfileDesktop extends StatefulWidget {
  const TeacherProfileDesktop({super.key});

  @override
  State<TeacherProfileDesktop> createState() => _TeacherProfileDesktopState();
}

class _TeacherProfileDesktopState extends State<TeacherProfileDesktop> {
