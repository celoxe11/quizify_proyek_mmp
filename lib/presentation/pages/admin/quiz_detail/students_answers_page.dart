...
class AdminStudentAnswersPage extends StatefulWidget {
  ...
  @override
  State<AdminStudentAnswersPage> createState() =>
      AdminStudentAnswersPageState();
}

class AdminStudentAnswersPageState extends State<AdminStudentAnswersPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<AdminStudentAnswersBloc, AdminStudentAnswersState>(
        builder: (context, state) {
          if (state is AdminStudentAnswersLoading) {
            return const Center(
              child: CircularProgressIndicator(color: AppColors.darkAzure),
            );
          }

          if (state is AdminStudentAnswersError) {
            return Center(
              child: Column(
          ...
          if (state is AdminStudentAnswersLoaded) {
  ...
  Widget _buildAnswersList(AdminStudentAnswersLoaded state) {
  ...
  Widget _buildAnswersSection(AdminStudentAnswersLoaded state) {
              ...
              children: [
                ...
                ...options.asMap().entries.map((entry) {
                  ...
                  return _buildOptionItem(
                    ...
                    showCorrect:
                        !(isCorrect ??
                            false), // Show correct answer if student was wrong
                  );
                }).toList(),
              ],
            ),
