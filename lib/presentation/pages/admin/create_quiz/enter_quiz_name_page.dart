...
class AdminEnterQuizNamePage extends StatefulWidget {
  const AdminEnterQuizNamePage({super.key});

  @override
  State<AdminEnterQuizNamePage> createState() =>
      _AdminEnterQuizNamePageState();
}

class _AdminEnterQuizNamePageState extends State<AdminEnterQuizNamePage> {
