...
class AdminQuizDesktop extends StatelessWidget {
  const AdminQuizDesktop({super.key});
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      actions: [
        // Search field
        BlocBuilder<AdminQuizzesBloc, AdminQuizzesState>(
          builder: (context, state) {
            return Container(
              width: 250,
              height: 40,
  ...
  Widget _buildHeader(BuildContext context, AdminQuizzesLoaded state) {
    return Row(
        ...
        Row(
          children: [
            ...
            _buildFilterChip(
              ...
              onSelected: () {
                context.read<AdminQuizzesBloc>().add(
                  const FilterAdminQuizzesEvent('public'),
                );
              },
              color: Colors.green,
            ),
            ...
            _buildFilterChip(
              ...
              onSelected: () {
                context.read<AdminQuizzesBloc>().add(
                  const FilterAdminQuizzesEvent('private'),
                );
              },
              color: Colors.orange,
            ),
