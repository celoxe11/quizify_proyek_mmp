...
/// Desktop layout for the Student Home page
///
/// Displays recommended quizzes and all public quizzes with search functionality
class StudentHomeDesktop extends StatefulWidget {
  const StudentHomeDesktop({super.key});

  @override
  State<StudentHomeDesktop> createState() => _StudentHomeDesktopState();
}

class _StudentHomeDesktopState extends State<StudentHomeDesktop> {
